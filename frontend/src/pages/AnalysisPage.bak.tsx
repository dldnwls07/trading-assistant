                ...
                {activeTab === 'themes' ? (
                    ...
                    >
                        ...
                        <div className="col-span-12 lg:col-span-8 space-y-6">
                            ...
                            {/* 1. Chart Section */}
                            <motion.div variants={itemVariants} className={`rounded-3xl p-1 border shadow-2xl relative group ${isDark ? 'bg-[#151e32] border-slate-700/50' : 'bg-white border-slate-200'}`}>
                                ...
                                {/* Chart Body - 고정 높이 450px (작은 화면 대응) */}
                                    ...
                                    {history.length > 0 ? (
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center text-center space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground/50 mt-1">Enter a ticker symbol to start AI analysis</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                        ...
                        <div className="col-span-12 lg:col-span-4 space-y-6">
                            ...
                            {/* 1. Strategic Signals (Accumulation/Liquidation/Stop Loss) */}
                            <motion.div variants={itemVariants}>
                                <StrategicSignals analysis={analysis} isDark={isDark} />
                            </motion.div>

                            {/* 2. Trading Setup Card (Primary Signal) */}
                            <motion.div variants={itemVariants}>
                                <TradingSetup analysis={analysis} isDark={isDark} />
                            </motion.div>

                            {/* 3. Strategy Card (Detailed Metrics) */}
                            <motion.div variants={itemVariants}>
                                <StrategyCard analysis={analysis} isDark={isDark} />
                            </motion.div>

                            {/* 4. Market Context / Calendar Widget */}
                            <motion.div variants={itemVariants}>
                                <CalendarWidget analysis={analysis} isDark={isDark} />
                            </motion.div>
